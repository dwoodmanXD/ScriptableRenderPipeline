...
// Depth and Alpha to coverage
    ...
    // Red channel is depth, Alpha channel is for alpha to coverage
    depthColor = float4(packedInput.vmesh.positionCS.z, 0, 0, builtinData.opacity);

    #ifdef _ALPHATOMASK_ON
    // source: https://medium.com/@bgolus/anti-aliased-alpha-test-the-esoteric-alpha-to-coverage
    depthColor.a = saturate((depthColor.a - 0.3) / max(fwidth(depthColor.a), 0.0001) + 0.5);
    #endif
#endif
