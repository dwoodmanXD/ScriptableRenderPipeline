...
namespace UnityEditor.ShaderGraph.Drawing
{
    ...
    {
        private const string k_InvalidShaderGUI = " is not a valid ShaderGUI";
        ...
        {
            if (m_CanChangeShaderGUI.OverrideEnabled && !ValidCustomEditorType(m_CanChangeShaderGUI.ShaderGUIOverride))
            {
                ...
                m_MasterNode.owner.messageManager?.AddOrAppendError(this, m_MasterNode.tempId,
                    new ShaderMessage(m_CanChangeShaderGUI.ShaderGUIOverride + k_InvalidShaderGUI, ShaderCompilerMessageSeverity.Warning));
            }
            else
            {
                m_MasterNode.owner.messageManager?.ClearNodesFromProvider(this, m_MasterNode.ToEnumerable());
